...
const navigation = [
  { name: "Display Antrian", href: "/list-display-antrean" },
  { name: "Farmasi", href: "/farmasi" },
  { name: "RSSC TV", href: "/video/rssctv" },
  { name: "Informasi Kamar", href: "/informasi-kamar" },
];
  ...
  return (
    <>
      {/*
        ...
        ```
      */}
      <div className="fixed w-full z-12">
        <Disclosure as="nav" className="bg-[#77b732]">
                ...
                <div className="flex">
                  <Link href={"/"}>
                    <img
                      alt="Rs. St. Carolus"
                      src="/logo_icare.png"
                      className="h-10 md:h-16 bg-white rounded-xl"
                    />
                  </Link>
                  {/* <Link
                    href="/"
                    ...
                    className={classNames(
                      ...
                      "rounded-md px-3 py-2 text-xl font-bold items-center"
                    )}
                  >
                    RS St. Carolus
                  </Link> */}
                    ...
                    {navigation.map((item) => {
                      ...
                      return (
                        <a
                          ...
                          className={classNames(
                            isActive
                              ? "bg-gray-950/50 text-white text-bold"
